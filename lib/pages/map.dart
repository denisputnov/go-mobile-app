...
class _MapWidgetState extends State<MapWidget> with SingleTickerProviderStateMixin {
  ...
  Future<Uint8List> getMarker() async {
    ByteData byteData = await DefaultAssetBundle.of(context).load("assets/icons/maps/location.png");
    return byteData.buffer.asUint8List();
  }

  Future<Uint8List> getRestaurantMarker() async {
    ByteData restaurantIcom = await DefaultAssetBundle.of(context).load("assets/icons/maps/location.png");
          ...
          child: Stack(
            children: [
              GoogleMap(
                ...
                markers: (filter.pharmacy ? Set.from(mergeMarkers()) : Set.of((marker != null) ? [marker] : [])),
